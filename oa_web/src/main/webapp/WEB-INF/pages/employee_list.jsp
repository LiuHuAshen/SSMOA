                    ...
                    <div class="row">
                        <div class="hidden-xs hidden-sm col-md-3">
                            <div class="btn-group">
                                ...
                                <button type="button" class="btn btn-default light">
                                    <i class="fa fa-plus" onclick="javascript:window.location.href='${path}/employee/to_add';"></i>
                                </button>
                            </div>
                        </div>
                ...
                <div class="panel-body pn">
                    <table id="message-table" class="table admin-form theme-warning tc-checkbox-1">
                        ...
                        <tr class="message-unread">
                            ...
                            <td>
                                <a href="${path}/employee/to_update?sn=${emp.sn}">编辑</a>
                                <a href="${path}/employee/remove?sn=${emp.sn}">删除</a>
                            </td>
                        </tr>
                        </c:forEach>
                        </tbody>
